...
list.of.packages <- c("ggplot2", "tidyverse", "ggmap", "extrafont", "tidyr", "dplyr", "forcats", "sp", "sf", "rgdal", "maptools", "rgeos", "scales", "ggrepel", "treemapify", "sf", "stringr")
...
joined_map_biz0408 <- full_join(comm_shapes2, biz_comms_byclass, by = "community") %>%
  ...
  group_by(community) %>%
  summarize(food = sum(food), biz_services = sum(biz_services),
